...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/groupmas/domains/staging.jhontamayo.dev/awstats/.data"
	# Other possible directories :				"/usr/local/etc/awstats",
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/groupmas/domains/staging.jhontamayo.dev/awstats/.data",
